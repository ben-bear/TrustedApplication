...
import com.yyy.djk.dropdownmenu.FirstPage;
...
public class RecAdapter extends BaseAdapter {
    ...
    public RecAdapter(Context context, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //根据自定义的Item布局加载布局
            convertView = mInflater.inflate(R.layout.list_item_fisrt, null);
